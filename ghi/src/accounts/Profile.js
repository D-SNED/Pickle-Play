...
export default function ProfilePage() {
    ...
    const getPlayerData = async (playerId) => {
        ...
        const response = await fetch(
            `${process.env.REACT_APP_API_HOST}/api/players/${playerId}`, {credentials: "include"});
            ...
            <section className="relative block h-500-px">
                <div className="absolute top-0 w-full h-full bg-center bg-cover">
                    <img
                        ...
                        alt=""
                    />
                    <span id="blackOverlay" className="w-full h-full absolute bg-floral-white"></span>
                </div>
            </section>
                        ...
                        <div className="px-6">
                            ...
                            <div className="py-5 flex flex-wrap justify-center">
                                ...
                                <button
                                    ...
                                    className="button active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150"
                                    type="button">
                                Delete Account
                                </button>
                                        ...
                                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                            <div className="sm:flex sm:items-start">
                                                <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                                                    <svg width="64px" height="64px" className="h-6 w-6 text-red-600" stroke="currentColor #ef4444" fill="none" viewBox="0 0 24.00 24.00" xmlns="http://www.w3.org/2000/svg" strokeWidth="0.45600000000000007">
