        ...
        <div className="bg-green flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                >
                    ...
                    <div>
                        <label htmlFor="skill-level-singles" className="block text-sm font-medium leading-6 text-gray-900">
                        Skill Level Singles
                        </label>
                        <div className="mt-2">
                            <select
                    ...
                    <div>
                        <label htmlFor="skill-level-doubles" className="block text-sm font-medium leading-6 text-gray-900">
                        Skill Level Doubles
                        </label>
                        <div className="mt-2">
                            <select
                    ...
                    <div>
                        <label htmlFor="emergency-contact-num" className="block text-sm font-medium leading-6 text-gray-900">
